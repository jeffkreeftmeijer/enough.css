...
Preformatted text in =<pre>= tags get a 40 pixel left margin, to match the left margin in lists, block quotes and figures.
This makes code blocks stand out from body text without adding a background color.
